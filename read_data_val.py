...
TRAIN_DIR = "products_10k_train_197"
...
def generate_pairs(paths, labels, class_size):
    ...
    print(f"Number of validation pairs: {len(pairs_output)}")
    print(f"Number of validation positives: {num_positve}")
    print(f"Number of validation negatives: {num_negative}")

    return np.array(pairs_output), np.array(labels_output)
